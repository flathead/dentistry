        ...
        <Wrapper>
          <div className={styles.about}>
            <div className={styles.aboutContent}>
              ...
              <p>
                Стоматология на <b>Демонстрации</b> — это клиника с новым и
                современным оборудованием в г. Тула. Здесь вы можете получить
                любую стоматологическую помощь экспертного класса без наценок.
              </p>
              <p>
